const WisataCard = ({ wisata, viewMode, onImageClick }) => {
  return (
    ...
    >
      <div
        className="flex-shrink-0 w-full md:w-48 h-40 md:h-32 overflow-hidden rounded-xl mb-4 md:mb-0 cursor-pointer"
        onClick={() => onImageClick(wisata.gallery, 0)}
      >
        <img
      ...
      <div className="flex-1">
        <h3 className="text-xl font-bold text-[#2A6218] mb-2">
          {wisata.nama_wisata}
        </h3>
        <p className="text-[#3F5231] mb-2">{wisata.pengantar_singkat}</p>
        <div className="text-sm text-[#65724D] mb-2">
